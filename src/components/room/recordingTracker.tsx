...
const RecordingTracker = () => {
    ...
    const handleStopRecording = async() => {
        ...
        toast.promise(
         new Promise(async(resolve, reject) => {
          const res= await fetch(`${process.env.NEXT_PUBLIC_APP_API}/api/save-recordings`, {
            method: 'POST',
            headers: {
        ...
        if(res.ok){
          resolve("Recording saved successfully, you can find it in your recordings") 
        } else{
          reject("Something went wrong, please try again")
           ...
           {
             loading: 'Saving...',
             success: <b>Recording saved successfully, you can find it in your recordings</b>,
    ...
    const formattedElapsedTime = moment.utc(moment.duration(elapsedTime, 'seconds').asMilliseconds()).format('mm:ss');
